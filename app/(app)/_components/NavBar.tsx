...
export default function NavBar() {
  ...
  return (
    ...
    >
      {/*
        SVG background with arch curving up around the Lumi circle.
        ViewBox 0 0 390 90:
          - y=22 is the normal nav top edge
          - arch peaks at y=0 in the center (22px above the flat edge)
          - nav content runs from y=22 to y=90
      */}
      <svg
      ...
      >
        <path
          d="M0,10 L148,10 C160,10 165,6.4 171,3.6 C178,0.9 187,0 195,0 C203,0 212,0.9 219,3.6 C225,6.4 230,10 242,10 L390,10 L390,90 L0,90 Z"
          fill="#1E1C2E"
        />
      </svg>

      <div className="relative flex items-end justify-around px-1 pt-3 pb-7">
        ...
        <Link href="/chat" className="flex flex-col items-center gap-1 flex-1 -mt-5">
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              ...
              <line x1="20" y1="11" x2="23" y2="11" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              <line x1="4.22" y1="3.8"  x2="6.34" y2="5.92" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              <line x1="19.78" y1="3.8" x2="17.66" y2="5.92" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              <line x1="3.22" y1="17.5" x2="5.34" y2="15.38" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              <line x1="20.78" y1="17.5" x2="18.66" y2="15.38" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              {/* Center circle */}
              <circle cx="12" cy="11" r="3" fill="#1E1C2E" />
              {/* Base stand */}
              <line x1="8" y1="21" x2="16" y2="21" stroke="#1E1C2E" strokeWidth="2" strokeLinecap="round" />
              <line x1="12" y1="17" x2="12" y2="21" stroke="#1E1C2E" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          </div>
