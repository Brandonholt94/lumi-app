...
export default function FocusPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── Body — centered column, max 520px on desktop ── */}
      <div className={`flex flex-col flex-1 px-6 pb-12${state === 'idle' ? ' lumi-focus-body-idle' : ''}`} style={{ paddingTop: 56, width: '100%', maxWidth: 680, marginLeft: 'auto', marginRight: 'auto' }}>
