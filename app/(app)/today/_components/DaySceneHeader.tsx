...
// ── Stars — r bumped ~1.45× for visibility ──
const STARS = [
  // top strip y 3-10
  { x: 15,  y: 5,  r: 0.51, o: 0.70, d: 2.3 }, { x: 48,  y: 4,  r: 0.41, o: 0.80, d: 3.1 },
  { x: 90,  y: 7,  r: 0.55, o: 0.60, d: 2.7 }, { x: 132, y: 3,  r: 0.41, o: 0.75, d: 1.9 },
  { x: 175, y: 8,  r: 0.61, o: 0.55, d: 3.4 }, { x: 218, y: 5,  r: 0.41, o: 0.65, d: 2.5 },
  { x: 260, y: 6,  r: 0.48, o: 0.70, d: 1.7 }, { x: 300, y: 4,  r: 0.41, o: 0.60, d: 3.8 },
  { x: 342, y: 9,  r: 0.55, o: 0.75, d: 2.2 }, { x: 378, y: 5,  r: 0.41, o: 0.65, d: 2.9 },
  // upper-mid y 14-25
  { x: 8,   y: 18, r: 0.41, o: 0.55, d: 4.1 }, { x: 36,  y: 22, r: 0.70, o: 0.85, d: 3.0 },
  { x: 68,  y: 15, r: 0.41, o: 0.55, d: 2.4 }, { x: 108, y: 20, r: 0.55, o: 0.72, d: 1.6 },
  { x: 148, y: 17, r: 0.46, o: 0.60, d: 3.7 }, { x: 185, y: 24, r: 0.41, o: 0.50, d: 2.0 },
  { x: 224, y: 14, r: 0.55, o: 0.65, d: 3.5 }, { x: 265, y: 21, r: 0.41, o: 0.58, d: 2.6 },
  { x: 305, y: 19, r: 0.48, o: 0.70, d: 3.2 }, { x: 350, y: 23, r: 0.41, o: 0.50, d: 4.0 },
  { x: 383, y: 16, r: 0.55, o: 0.60, d: 2.8 },
  // mid y 30-45
  { x: 22,  y: 35, r: 0.75, o: 0.88, d: 1.8 }, { x: 58,  y: 38, r: 0.41, o: 0.52, d: 3.3 },
  { x: 98,  y: 32, r: 0.48, o: 0.65, d: 2.5 }, { x: 138, y: 42, r: 0.41, o: 0.48, d: 3.9 },
  { x: 178, y: 36, r: 0.55, o: 0.68, d: 2.1 }, { x: 218, y: 44, r: 0.41, o: 0.52, d: 4.2 },
  { x: 255, y: 33, r: 0.62, o: 0.80, d: 1.9 }, { x: 292, y: 40, r: 0.41, o: 0.55, d: 3.6 },
  { x: 328, y: 37, r: 0.48, o: 0.62, d: 2.3 }, { x: 368, y: 43, r: 0.41, o: 0.48, d: 4.4 },
  // lower-mid y 52-68
  { x: 14,  y: 55, r: 0.41, o: 0.50, d: 2.7 }, { x: 54,  y: 62, r: 0.55, o: 0.65, d: 3.4 },
  { x: 95,  y: 56, r: 0.41, o: 0.55, d: 2.0 }, { x: 138, y: 64, r: 0.48, o: 0.58, d: 3.8 },
  { x: 180, y: 58, r: 0.70, o: 0.80, d: 1.7 }, { x: 222, y: 65, r: 0.41, o: 0.50, d: 4.3 },
  { x: 262, y: 54, r: 0.48, o: 0.62, d: 2.9 }, { x: 302, y: 62, r: 0.41, o: 0.55, d: 3.1 },
  { x: 345, y: 57, r: 0.55, o: 0.68, d: 2.5 }, { x: 382, y: 65, r: 0.41, o: 0.48, d: 3.7 },
  // low y 75-95
      ...
      <div style={{ position: 'relative' }}>
        ...
        >
          <defs>
            ...
            {scene === 'evening' && (
              <mask id="moonMask">
                <circle cx="72" cy="36" r="8"    fill="white"/>
                <circle cx="76" cy="33" r="6.5"  fill="black"/>
              </mask>
            )}
            {/* Night crescent mask */}
            {scene === 'night' && (
              <mask id="moonMask">
                ...
                <circle cx="76.5" cy="32.5" r="8" fill="black"/>
              </mask>
            )}
          </defs>
          ...
          {(scene === 'evening' || scene === 'night') && <>
            {scene === 'night' && <circle cx="72" cy="36" r="22" fill="url(#moonGlow)"/>}
            <circle
              cx="72" cy="36"
              r={scene === 'night' ? 10 : 8}
              fill={scene === 'night' ? '#FFF6DC' : '#EEE4C0'}
              fillOpacity={scene === 'night' ? 0.92 : 0.65}
              mask="url(#moonMask)"
            />
          </>}
