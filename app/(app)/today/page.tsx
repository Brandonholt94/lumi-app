    ...
    <div className="flex flex-col h-full overflow-y-auto" style={{ background: '#FBF8F5' }}>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <Link href="/focus" className="flex flex-col items-start active:scale-[0.97] transition-transform" style={{
          ...
          <span style={{ fontFamily: 'var(--font-fraunces)', fontSize: '16px', fontWeight: 700, color: '#1E1C2E', marginBottom: 3, lineHeight: 1.2 }}>Focus</span>
        ...
        <Link href="/capture" className="flex flex-col items-start active:scale-[0.97] transition-transform" style={{
          ...
          <span style={{ fontFamily: 'var(--font-fraunces)', fontSize: '16px', fontWeight: 700, color: '#1E1C2E', marginBottom: 3, lineHeight: 1.2 }}>Brain Dump</span>
      ...
      <Link href="/chat" className="flex items-center active:scale-[0.98] transition-transform mb-2" style={{
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontFamily: 'var(--font-fraunces)', fontSize: '17px', fontWeight: 700, color: '#1E1C2E', marginBottom: 2, lineHeight: 1.2 }}>Talk to Lumi</p>
