  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {phase === 'credentials' && (
          <>
            <h1 style={{ fontFamily: 'var(--font-aegora)', fontSize: 26, fontWeight: 500, color: '#1E1C2E', marginBottom: 4, lineHeight: 1.1 }}>
              Welcome back.
            </h1>
        ...
        {phase === 'forgot-email' && (
          <>
            ...
            <h1 style={{ fontFamily: 'var(--font-aegora)', fontSize: 24, fontWeight: 500, color: '#1E1C2E', marginBottom: 4, lineHeight: 1.1 }}>
              Reset your password
            </h1>
            <p style={{ fontFamily: 'var(--font-nunito-sans)', fontSize: 13, fontWeight: 600, color: '#9895B0', marginBottom: 28 }}>
        ...
        {phase === 'forgot-code' && (
          <>
            ...
            <h1 style={{ fontFamily: 'var(--font-aegora)', fontSize: 24, fontWeight: 500, color: '#1E1C2E', marginBottom: 4, lineHeight: 1.1, textAlign: 'center' }}>
              Check your email
            </h1>
